...
<div class="standard-admin-page">
    ...
    <div id="hooks-reload-container">
        <button id="hooks-reload-button" class="toolbar-button" type="submit" title="Reload jar files from the hooks containing folder"><span class="button-image sbb-icon-reload" role="img" aria-label="Reload"></span>Reload hooks list</button>
    </div>
