...
const REST_PATH = '/polarion/interceptor-manager/rest';
...
export default function useRemote() {
  ...
  const networkErrorResponse = () =>
    new Response(
      JSON.stringify({
        errorMessage: 'Network error occurred. Be sure Polarion is started and accessible.',
      }),
      {
        status: 503,
